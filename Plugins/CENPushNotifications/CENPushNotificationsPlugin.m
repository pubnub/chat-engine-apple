...
+ (void)enablePushNotifications:(BOOL)enable
    ...
    CENPushNotificationsExtension *extension = [me extensionWithIdentifier:identifier];
...
+ (void)disableAllForUser:(CENMe *)user
    ...
    CENPushNotificationsExtension *extension = [user extensionWithIdentifier:identifier];
