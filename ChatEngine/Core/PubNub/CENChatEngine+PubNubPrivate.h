...
/**
 * @brief Unique identifier of user, which currently connected with \b {ChatEngine CENChatEngine}
 * client.
 */
 ...
 *
 * @param uuid Unique identifier for which \b {ChatEngine CENChatEngine} should be prepared
