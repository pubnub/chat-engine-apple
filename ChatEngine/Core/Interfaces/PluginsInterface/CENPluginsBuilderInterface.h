...
/**
 * @brief \b {CENChatEngine} plugins management API access builder.
 *
 * @ref 3b577502-3824-47ed-972d-4e23a601e1cf
 *
 ...
 *
 * @param identifier Plugin identifier under which initialized plugin will be stored and can be
 *     retrieved.
 ...
 * configuration.
 *
 * @ref 9791311e-5034-4953-afc2-57fa038c9903
 */
 ...
 * configuration.
 *
 * @ref 0379bcff-1d16-4caa-8c29-102d610a29a9
 */
