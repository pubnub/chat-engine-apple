...
/**
 * @brief \b {ChatEngine CENChatEngine} users manager.
 *
 ...
 *
 * @param chatEngine \b {ChatEngine CENChatEngine} instance which manage list of active / known
 *     users.
 *
 ...
 * @param state State which can be bound to user on \b {CENChatEngine.global} chat if
 *     \b {CENConfiguration.enableGlobal} set to \c YES.
 *
