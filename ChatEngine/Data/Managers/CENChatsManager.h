...
/**
 * @brief \b {CENChatEngine} chats manager.
 *
 * @discussion Manager responsible for \b {chat CENChat} creation and maintenance.
 *
 * @ref 4a07df5d-f4cf-4eb2-8c41-e92709768f5d
 *
...
/**
 * @brief Global communication \b {chat CENChat}.
 */
 ...
 *
 * @param chatEngine \b {CENChatEngine} instance for which \b {chats CENChat} should be
 *     managed.
 *
 ...
 *     \b {CENConfiguration.enableMeta} to \c YES during \b {CENChatEngine}
 *     configuration.
 *
 * @return Configured and ready to use \b {chat CENChat}.
 */
