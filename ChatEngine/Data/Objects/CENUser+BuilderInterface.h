 ...
 */
@property (nonatomic, readonly, strong) CENUser * (^on)(NSString *event, id handlerBlock);
 ...
 * @return Refererence on \b CENChat subclass which can be used to chain other methods call.
 */
@property (nonatomic, readonly, strong) CENUser * (^onAny)(id handlerBlock);
 ...
 * @return Refererence on \b CENChat subclass which can be used to chain other methods call.
 */
@property (nonatomic, readonly, strong) CENUser * (^once)(NSString *event, id handlerBlock);
 ...
 * @return Refererence on \b CENChat subclass which can be used to chain other methods call.
 */
@property (nonatomic, readonly, strong) CENUser * (^off)(NSString *event, id handlerBlock);
 ...
 * @return Refererence on \b CENChat subclass which can be used to chain other methods call.
 */
@property (nonatomic, readonly, strong) CENUser * (^offAny)(id handlerBlock);
